...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //设置根控制器
    self.window.rootViewController  = [SQSelectRootTool chooseRootVC];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.dilireba.__" in the application's documents directory.
